...
//         )
//         .unwrap_json();
//     assert_eq!(res, amount.saturating_div(2));
//
//     let terminator_balance = e.ft_balance_of(&users.eve);
//     assert_eq!(terminator_balance, amount.saturating_div(2));
//
//     let lockups = e.get_account_lockups(&users.alice);
//     assert_eq!(lockups[0].1.total_balance, amount.saturating_div(2));
...
//
//     let lockups = e.get_account_lockups(&users.alice);
//     assert_eq!(lockups[0].1.unclaimed_balance, amount.saturating_div(4));
//
...
//     assert_eq!(balance, amount.saturating_div(2));
//
...
//     assert_eq!(lockup.total_balance, amount.saturating_div(2));
//     assert_eq!(lockup.claimed_balance, amount.saturating_div(2));
